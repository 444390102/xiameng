												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input name="acc" value="admin" type="text" class="form-control" placeholder="用户名" />
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input name="pwd" value="admin" type="password" class="form-control" placeholder="密码" />
										...
										<div class="widget-main">
											...
											<form action="jsp/main.jsp">
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="email" class="form-control" placeholder="账户名" />
															<i class="ace-icon fa fa-envelope"></i>
														</span>
													</label>
	...
	<script>
		...
		$(function (){
			$("#btn_login").click(function (){
				//登录
				$.post("loginAction",$("#loginForm").serializeArray(),function (result){
					if (result.code == 200){
